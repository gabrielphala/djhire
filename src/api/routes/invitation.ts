...
export default (app: Application) => {
    ...
    app.post('/invitation/accept', baseController.wrap_with_store(invitationServices.accept))
    app.post('/invitation/deny', baseController.wrap_with_store(invitationServices.deny))
